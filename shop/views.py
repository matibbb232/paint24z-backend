...
from .models import Products, Manufacturers, Categories, Store, Addresses, Orders
from .serializers import ProductsSerializer, CategoriesSerializer, StoreSerializer, CartSerializer
...
def get_product(request, id):
    ...
    if product_info:
        ...
        serializer = ProductsSerializer(product, fields=('name', 'price'))  # Only name and price
...
def get_cart(request, id):
    ...
    serializer = CartSerializer(orders, many=True, context={'product_info': product_info})
    return Response(serializer.data)
